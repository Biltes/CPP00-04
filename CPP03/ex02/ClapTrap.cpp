...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/12 12:35:05 by migupere          #+#    #+#             */
/*   Updated: 2024/12/12 15:43:25 by migupere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount){
	if (_hitPoints > 0)
	{
		...
		if (_hitPoints <= amount)
			_hitPoints = 0;
		if (_attackDamage > _hitPoints)
			std::cout << "ClapTrap " << _name << " received a critical hit and went down!" << std::endl;
		else
			_hitPoints -= amount;
